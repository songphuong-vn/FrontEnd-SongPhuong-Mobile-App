...
**Song Phương Mobile App** được xây dựng nhằm giải quyết bài toán khó khăn của người dùng khi chọn mua linh kiện máy tính trên điện thoại: *Làm sao để xem hàng ngàn sản phẩm, kiểm tra tương thích và tự xây dựng cấu hình máy tính một cách trực quan, nhanh chóng nhất?*
